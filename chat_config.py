...
def get_chat_config(file_path: str) -> ChatConfig:
    import os
    import json
    ...
    try:
        ...
        raise PermissionError(f"Permission denied when reading chat config file: {path}") from e
    except json.JSONDecodeError as e:
        raise ValueError(f"Invalid JSON in chat config file: {path}") from e
