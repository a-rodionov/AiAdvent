...
TBD — This capability defines the `ILlmPortFactory` port interface and its `LlmPortFactoryAdapter` infrastructure implementation for creating and caching `ILlmPort` instances per session and provider.
