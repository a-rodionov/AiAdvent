...
TBD — This capability defines the `ILlmPort` interface contract for LLM completion providers in the domain layer.
...
- **WHEN** a developer inspects `ILlmPort` in `server/domain/interfaces/llm_port.py`
