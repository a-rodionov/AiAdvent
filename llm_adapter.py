...
def _build_kwargs(completion_config: CompletionConfig, messages: list, is_stream_prefered: bool) -> dict:
    ...
    if completion_config.output_config is not None:
        kwargs["response_format"] = response_format=completion_config.output_config
...
class LlmAdapter:
    ...
    async def acompletion(self, full_messages: list, completion_config: CompletionConfig, is_stream_prefered: bool) -> AsyncGenerator[CompletionEvent, None]:
        ...
        if kwargs.get("stream", False) is False:
            ...
            async for chunk in stream:
                ...
                if choice.finish_reason:
                    ...
                    if (StopReason.STOP == StopReason(stop_reason) and
